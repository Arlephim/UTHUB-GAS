...
void AUTHUB_GAS2025PlayerController::GenericActionFunc(const FInputActionInstance& InputActionInstance)
{
	...
	if (DataComponent && ASC)
	{
		...
		ASC->TryActivateAbilityByClass(DataComponent->DefaultAbility);
	}
}
...
void AUTHUB_GAS2025PlayerController::SetupInputComponent()
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(InputComponent))
	{
		...
		// Custom events
		EnhancedInputComponent->BindAction(GenericAction, ETriggerEvent::Started, this, &ThisClass::GenericActionFunc);
	}
	else
	{
